...
Vasern is a fast and open source data storage for React Native. [Join us on Slack](https://vasern.slack.com/).
...
- For quick questions, chat and discussion, [join us on Slack](https://vasern.slack.com/).
